...
• {h.name} ({h.recurrence}) - streak: {h.streak}"
        keyboard = [[InlineKeyboardButton("➕ Add Habit", callback_data="hb_add")],[InlineKeyboardButton("✅ Mark Done", callback_data="hb_done")]]
...
async def habits_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state == "habit_name":
        ...
        keyboard = [[InlineKeyboardButton("Daily", callback_data="hr_daily")],[InlineKeyboardButton("Weekly", callback_data="hr_weekly")],[InlineKeyboardButton("Mon-Fri", callback_data="hr_weekdays")]]
